...
public class ChapasWorld2DTest implements ApplicationListener, InputProcessor {
...
//	BitmapFont font;
	...
	protected void createWorld (World world) {
		...
		Body ground;
		{
			...
			shape.set(new Vector2(-2.5f, 0), new Vector2(2.5f, 0));
			ground.createFixture(shape, 0);
			
			shape.set(new Vector2(-2, 4), new Vector2(2.0f, 4));
			ground.createFixture(shape, 0);
...
//		batch.end();
	...
	public void create () {
		...
		camera = new OrthographicCamera(4.8f, 8.0f);
		camera.position.set(0, 0f, 0);
		camera.zoom=1.0f;
